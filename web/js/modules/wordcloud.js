 ...
 */
    function(t) {
        "object" == typeof module && module.exports ? (t.default = t,
            module.exports = t) : "function" == typeof define && define.amd ? define("highcharts/modules/wordcloud", ["web/js/highcharts"], function(e) {
            return t(e),
                t.Highcharts = e,
                t
        ...
        var e = t ? t._modules : {};
        function i(e, i, o, n) {
            e.hasOwnProperty(i) || (e[i] = n.apply(null, o),
        ...
        i(e, "Series/DrawPointUtilities.js", [], function() {
            return {
                draw: function(t, e) {
                    let {animatableAttribs: i, onComplete: o, css: n, renderer: r} = e
                        , a = t.series && t.series.chart.hasRendered ? void 0 : t.series && t.series.options.animation
                        , l = t.graphic;
                    if (e.attribs = {
                        ...e.attribs,
                        ...
                        t.shouldDraw())
                        l || (l = "text" === e.shapeType ? r.text() : "image" === e.shapeType ? r.image(e.imageUrl || "").attr(e.shapeArgs || {}) : r[e.shapeType](e.shapeArgs || {}),
                            t.graphic = l,
                            l.add(e.group)),
                        n && l.css(n),
                            l.attr(e.attribs).animate(i, !e.isNew && a, o);
                    else if (l) {
                        let e = () => {
                                t.graphic = l = l && l.destroy(),
                                "function" == typeof o && o()
                            }
                        ;
            ...
            i(e, "Series/Wordcloud/WordcloudPoint.js", [e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function(t, e) {
                let {column: {prototype: {pointClass: i}}} = t.seriesTypes
                    , {extend: o} = e;
                class n extends i {
                    isValid() {
                        return !0
            ...
            i(e, "Series/Wordcloud/WordcloudUtils.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function(t, e) {
                let {deg2rad: i} = t
                    , {extend: o, find: n, isNumber: r, isObject: a, merge: l} = e;
                function s(t, e) {
                ...
                function h(t) {
                    let e, i = t.axes || [];
                    return i.length || (i = [],
                        t.concat([t[0]]).reduce( (t, e) => {
                                let o = function(t, e) {
                                    let i = e[0] - t[0]
                                        , o = e[1] - t[1];
                                    return [[-o, i], [o, -i]]
                                }(t, e)[0];
                                return n(i, t => t[0] === o[0] && t[1] === o[1]) || i.push(o),
                                    e
                            }
                        ),
                        t.axes = i),
                ...
                function c(t, e) {
                    let i = 4 * t
                        ...
                        , a = !1;
                    return n -= 1,
                    t <= 1e4 && ("boolean" == typeof a && i >= r - n && (a = {
                        x: o - (r - i),
                        y: -o
                    }),
                        r -= n,
                    "boolean" == typeof a && i >= r - n && (a = {
                        x: -o,
                        y: -o + (r - i)
                    }),
                        r -= n,
                    "boolean" == typeof a && (a = i >= r - n ? {
                        x: -o + (r - i),
                        y: o
                    } : {
                        x: o,
                ...
                return {
                    archimedeanSpiral: function(t, e) {
                        ...
                        return t <= 1e4 && !(Math.min(Math.abs((r = {
                            x: n * Math.cos(n),
                            y: n * Math.sin(n)
                        }).x), Math.abs(r.y)) < o) && (r = !1),
                            r
                    },
                    extendPlayingField: function(t, e) {
                        let i, o, n, r, s, h, d, u;
                        return a(t) && a(e) ? (i = e.bottom - e.top,
                            h = (s = (o = e.right - e.left) * (n = t.ratioX) > i * (r = t.ratioY) ? o : i) * n,
                            d = s * r,
                            u = l(t, {
                                width: t.width + 2 * h,
                                height: t.height + 2 * d
                    ...
                    getBoundingBoxFromPolygon: function(t) {
                        return t.reduce(function(t, e) {
                            let i = e[0]
                                , o = e[1];
                            return t.left = Math.min(i, t.left),
                                t.right = Math.max(i, t.right),
                                t.bottom = Math.max(o, t.bottom),
                    ...
                    getPlayingField: function(t, e, i) {
                        let o = i.reduce(function(t, e) {
                            ...
                            return t.maxHeight = Math.max(t.maxHeight, i.height),
                                t.maxWidth = Math.max(t.maxWidth, i.width),
                                t.area += o * o,
                                t
                        }, {
                            maxHeight: 0,
                    ...
                    getPolygon: function(t, e, i, o, n) {
                        let r = [t, e]
                            ...
                            , s = e - o / 2
                            , h = e + o / 2;
                        return [[a, s], [l, s], [l, h], [a, h]].map(function(t) {
                            return g(t, r, -n)
                        })
                    },
                    ...
                    getRotation: function(t, e, i, o) {
                        let n = !1, a;
                        return r(t) && r(e) && r(i) && r(o) && t > 0 && e > -1 && o > i && (a = (o - i) / (t - 1 || 1),
                            n = i + e % t * a),
                            n
                    },
                    ...
                    intersectionTesting: function(t, e) {
                        ...
                        for (t.polygon = h,
                                 t.rotation = e.rotation; !1 !== m && (function(t, e) {
                            let i = t.rect
                                , o = t.polygon
                                , r = t.lastCollidedWith
                                , a = function(e) {
                                let n = s(i, e.rect);
                                return n && (t.rotation % 90 || e.rotation % 90) && (n = u(o, e.polygon)),
                                    n
                            }
                                , l = !1;
                            return !r || (l = a(r)) || delete t.lastCollidedWith,
                            l || (l = !!n(e, function(e) {
                                let i = a(e);
                                return i && (t.lastCollidedWith = e),
                                    i
                            })),
                                l
                        }(t, i) || function(t, e) {
                            ...
                            a(m = d(p)) && (c.left = l.left + m.x,
                                c.right = l.right + m.x,
                                c.top = l.top + m.y,
                                c.bottom = l.bottom + m.y,
                                t.polygon = function(t, e, i) {
                    ...
                    updateFieldBoundaries: function(t, e) {
                        return (!r(t.left) || t.left > e.left) && (t.left = e.left),
                        (!r(t.right) || t.right < e.right) && (t.right = e.right),
                        (!r(t.top) || t.top > e.top) && (t.top = e.top),
                        (!r(t.bottom) || t.bottom < e.bottom) && (t.bottom = e.bottom),
                            t
                    }
                }
            }),
            i(e, "Series/Wordcloud/WordcloudSeries.js", [e["Series/DrawPointUtilities.js"], e["Core/Globals.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"], e["Series/Wordcloud/WordcloudPoint.js"], e["Series/Wordcloud/WordcloudSeriesDefaults.js"], e["Series/Wordcloud/WordcloudUtils.js"]], function(t, e, i, o, n, r, a) {
                let {noop: l} = e
                    , {column: s} = i.seriesTypes
                    , {extend: h, isArray: d, isNumber: u, isObject: c, merge: p} = o
                    , {archimedeanSpiral: m, extendPlayingField: g, getBoundingBoxFromPolygon: f, getPlayingField: y, getPolygon: x, getRandomPosition: b, getRotation: w, getScale: M, getSpiral: S, intersectionTesting: W, isPolygonsColliding: A, rectangularSpiral: j, rotate2DToOrigin: C, rotate2DToPoint: F, squareSpiral: P, updateFieldBoundaries: v} = a;
                class T extends s {
                    pointAttribs(t, i) {
                        let o = e.seriesTypes.column.prototype.pointAttribs.call(this, t, i);
                        return delete o.stroke,
                    ...
                    drawPoints() {
                        let e = this.hasRendered, i = this.xAxis, o = this.yAxis, n = this.chart, r = this.group, a = this.options, l = a.animation, s = a.allowExtendPlayingField, d = n.renderer, p = [], m = this.placementStrategy[a.placementStrategy], b = a.rotation, w = this.points.map(function(t) {
                            return t.weight
                        }), A = Math.max.apply(null, w), j = this.points.concat().sort( (t, e) => e.weight - t.weight), C = d.text().add(r), F;
                        ...
                        for (let i of j) {
                            ...
                            }), M = x(y.x, y.y, i.dimensions.width, i.dimensions.height, y.rotation), S = f(M), C = W(i, {
                                rectangle: S,
                                polygon: M,
                                field: F,
                                placed: p,
                ...
                return T.defaultOptions = p(s.defaultOptions, r),
                    h(T.prototype, {
                        animate: l,
                        animateDrilldown: l,
                    ...
                    i.registerSeriesType("wordcloud", T),
                    T
            }),
