 ...
 */
    function(t, e) {
        ...
        function i(e, i, s, r) {
            ...
            t && "function" == typeof CustomEvent && t.dispatchEvent(new CustomEvent("HighchartsModuleLoaded",{
                detail: {
                    path: i,
                    module: e[i]
                }
 ...
 - ${i}: ${e}`,
            ...
            i(e, "Core/Renderer/SVG/SVGElement.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Color/Color.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function(t, e, i, s) {
                let {animate: r, animObject: o, stop: n} = t
                    ...
                    , {addEvent: p, attr: u, createElement: g, crisp: f, css: m, defined: x, erase: y, extend: b, fireEvent: v, isArray: S, isFunction: C, isObject: k, isString: M, merge: w, objectEach: T, pick: A, pInt: P, pushUnique: L, replaceNested: O, syncTimeout: D, uniqueKey: E} = s;
                class I {
                    _defaultGetter(t) {
                    ...
                    attr(t, e, i, s) {
                        ...
                        return "string" == typeof t && void 0 !== e && (a = t,
                            (t = {})[a] = e),
                            "string" == typeof t ? l = (this[t + "Getter"] || this._defaultGetter).call(this, t, r) : (T(t, function(e, i) {
                                d = !1,
                                s || n(this, i),
                    ...
                    titleSetter(t) {
                        ...
                        e.insertBefore ? e.insertBefore(i, e.firstChild) : e.appendChild(i),
                            i.textContent = O(A(t, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">")
                    }
                    toFront() {
                        let t = this.element;
            ...
            i(e, "Core/Renderer/SVG/SVGRenderer.js", [e["Core/Renderer/HTML/AST.js"], e["Core/Defaults.js"], e["Core/Color/Color.js"], e["Core/Globals.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Renderer/SVG/SVGElement.js"], e["Core/Renderer/SVG/SVGLabel.js"], e["Core/Renderer/SVG/Symbols.js"], e["Core/Renderer/SVG/TextBuilder.js"], e["Core/Utilities.js"]], function(t, e, i, s, r, o, n, a, h, l) {
                ...
                let {defaultOptions: c} = e
                    ...
                    , {addEvent: C, attr: k, createElement: M, crisp: w, css: T, defined: A, destroyObjectProperties: P, extend: L, isArray: O, isNumber: D, isObject: E, isString: I, merge: j, pick: B, pInt: R, replaceNested: z, uniqueKey: N} = l;
                class W {
                    constructor(t, e, i, s, r, o, n) {
                        ...
                        -1 === t.innerHTML.indexOf("xmlns") && k(d, "xmlns", this.SVG_NS),
                            ...
                            this.createElement("desc").add().element.appendChild(g.createTextNode("Created with Highcharts 11.4.8")),
                    ...
                    crispLine(t, e) {
                        let[i,s] = t;
                        return A(i[1]) && i[1] === s[1] && (i[1] = s[1] = w(i[1], e)),
                        A(i[2]) && i[2] === s[2] && (i[2] = s[2] = w(i[2], e)),
                            t
                    }
                    path(t) {
                    ...
                    symbol(t, e, i, s, r, o) {
                        ...
                        if (m)
                            ...
                            A(e) && s.attr({
                                ...
                                s.isImg = !0,
                                s.symbolUrl = t,
                                A(s.imgwidth) && A(s.imgheight) ? l(s) : (s.attr({
                                    width: 0,
                                    height: 0
                                }),
                                    M("img", {
            ...
            i(e, "Core/Axis/Tick.js", [e["Core/Templating.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function(t, e, i) {
                ...
                return class {
                    ...
                    addLabel() {
                        ...
                        let A = e => f.formatter ? f.formatter.call(e, e) : f.format ? (e.text = i.defaultLabelFormatter.call(e),
            ...
            i(e, "Core/Axis/Axis.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Axis/AxisDefaults.js"], e["Core/Color/Color.js"], e["Core/Defaults.js"], e["Core/Foundation.js"], e["Core/Globals.js"], e["Core/Axis/Tick.js"], e["Core/Utilities.js"]], function(t, e, i, s, r, o, n, a) {
                let {animObject: h} = t
                    ...
                    , {deg2rad: u} = o
                    , {arrayMax: g, arrayMin: f, clamp: m, correctFloat: x, defined: y, destroyObjectProperties: b, erase: v, error: S, extend: C, fireEvent: k, getClosestDistance: M, insertItem: w, isArray: T, isNumber: A, isString: P, merge: L, normalizeTickInterval: O, objectEach: D, pick: E, relativeLength: I, removeEvent: j, splat: B, syncTimeout: R} = a
                ...
                class N {
                    ...
                    init(t, e, i=this.coll) {
                        ...
                        let o = this.options
                            , n = o.labels;
                        this.type ?? (this.type = o.type || "linear"),
                        this.uniqueNames ?? (this.uniqueNames = o.uniqueNames ?? !0),
                            k(this, "afterSetType"),
                            this.userOptions = e,
                            ...
                            this.hasNames = "category" === this.type || !0 === o.categories,
                            this.categories = T(o.categories) && o.categories || (this.hasNames ? [] : void 0),
                    ...
                    defaultLabelFormatter() {
                        let t = this.axis, {numberFormatter: e} = this.chart, i = A(this.value) ? this.value : NaN, s = t.chart.time, r = t.categories, o = this.dateTimeLabelFormat, n = c.lang, a = n.numericSymbols, h = n.numericSymbolMagnitude || 1e3, l = t.logarithmic ? Math.abs(i) : t.tickInterval, d = a && a.length, p, u;
                        if (r)
                            u = `${this.value}`;
                        else if (o)
                            u = s.dateFormat(o, i);
                                        ...
                                        if (i.reserveSpace()) {
                                            ...
                                            e.positiveValuesOnly && 0 >= (o || 0) && (o = void 0),
                                                ...
                                                (r = i.xData) && r.length && (r = e.logarithmic ? r.filter(t => t > 0) : r,
                                                    ...
                                                    a = t.max,
                                                A(n) || n instanceof Date || (r = r.filter(A),
                                                    n = (t = i.getXExtremes(r)).min,
                                                    a = t.max),
                                                ...
                                                A(t.dataMin) && (n = t.dataMin,
                                                    e.dataMin = Math.min(E(e.dataMin, n), n)),
                                                A(t.dataMax) && (a = t.dataMax,
                                                    e.dataMax = Math.max(E(e.dataMax, a), a)),
                                                y(o) && (e.threshold = o),
                    ...
                    getPlotLinePath(t) {
                        ...
                        return k(this, "getPlotLinePath", v, function(t) {
                            u = f = (c = m(c = E(c, e.translate(n, void 0, void 0, o)), -1e9, 1e9)) + d,
                                g = x = h - c - d,
                                A(c) ? e.horiz ? (g = r,
                    ...
                    adjustForMinRange() {
                        ...
                        A(i) && A(s) && A(r) && i - s < r && (n = this.dataMax - this.dataMin >= r,
                            o = (r - i + s) / 2,
                            a = [s - o, E(t.min, s - o)],
                    ...
                    nameToX(t) {
                        let e = T(this.options.categories), i = e ? this.categories : this.names, s = t.options.x, r;
                        return t.series.requireSorting = !1,
                        y(s) || (s = this.uniqueNames && i ? e ? i.indexOf(t.name) : E(i.keys[t.name], -1) : t.series.autoIncrement()),
                    ...
                    setTickInterval(t) {
                        ...
                        if (o || e || b || this.getTickAmount(),
                            ...
                            this.type !== b.type && S(11, !0, i)) : (l && y(d) && A(s) && A(r) && (r >= d ? (L = d,
                                M = 0) : s <= d && (O = d,
                                C = 0)),
                                this.min = E(D, L, r),
                                this.max = E(I, O, s)),
                        A(this.max) && A(this.min) && (a && (this.positiveValuesOnly && !t && 0 >= Math.min(this.min, E(r, this.min)) && S(10, !0, i),
                            this.min = x(a.log2lin(this.min), 16),
                            this.max = x(a.log2lin(this.max), 16)),
                        this.range && A(r) && (this.userMin = this.min = D = Math.max(r, this.minFromRange() || 0),
                            this.userMax = I = this.max,
                            this.range = void 0)),
                            k(this, "foundExtremes"),
                            this.adjustForMinRange(),
                        A(this.min) && A(this.max)) {
                            if (!A(this.userMin) && A(m) && m < this.min && (this.min = D = m),
                            !A(this.userMax) && A(f) && f > this.max && (this.max = I = f),
                        ...
                        if (this.min !== this.max && A(this.min) && A(this.max) ? b && !P && v === b.options.tickPixelInterval ? this.tickInterval = P = b.tickInterval : this.tickInterval = E(P, this.tickAmount ? w / Math.max(this.tickAmount - 1, 1) : void 0, e ? 1 : w * v / Math.max(this.len, v)) : this.tickInterval = 1,
                        n && !t) {
                    ...
                    setTickPositions() {
                        ...
                        !this.isLinked && A(this.min) && A(this.max) && (this.single && a.length < 2 && !this.categories && !this.series.some(t => t.is("heatmap") && "between" === t.options.pointPlacement) && (this.min -= .5,
                            this.max += .5),
                    ...
                    getThresholdAlignment(t) {
                        if ((!A(this.dataMin) || this !== t && this.series.some(t => t.isDirty || t.isDirtyData)) && this.getSeriesExtremes(),
                            A(this.threshold)) {
                    ...
                    adjustTickAmount() {
                        ...
                        if (A(a) && (u = a < .5 ? Math.ceil(a * (n - 1)) : Math.floor(a * (n - 1)),
                        r.reversed && (u = n - 1 - u)),
                        t.hasData() && A(s) && A(i)) {
                            let a = () => {
                                    t.transA *= (h - 1) / (n - 1),
                    ...
                    unsquish() {
                        ...
                        if (i) {
                            if (!t.staggerLines && (A(o) ? p = [o] : r < t.autoRotationLimit && (p = t.autoRotation)),
                                p) {
                                let t, e;
                                for (let i of p)
                        ...
                        return this.autoRotation = p,
                            this.labelRotation = E(d, A(o) ? o : 0),
                            t.step ? s : l
                    }
                    getSlotWidth(t) {
                        let e = this.chart
                    ...
                    getOffset() {
                        let t = this, {chart: e, horiz: i, options: s, side: r, ticks: o, tickPositions: n, coll: a} = t, h = e.inverted && !t.isZAxis ? [1, 0, 3, 2][r] : r, l = t.hasData(), d = s.title, c = s.labels, p = A(s.crossing), u = e.axisOffset, g = e.clipOffset, f = [-1, 1, 1, -1][r], m, x = 0, b, v = 0, S = 0, C, M;
            ...
            i(e, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [e["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], e["Core/Utilities.js"]], function(t, e) {
                let {addEvent: i, arrayMax: s, arrayMin: r, defined: o, destroyObjectProperties: n, erase: a, fireEvent: h, merge: l, objectEach: d, pick: c} = e;
                class p {
                    static compose(e, s) {
                    ...
                    render() {
                        h(this, "render");
                        let {axis: t, options: e} = this, {horiz: i, logarithmic: s} = t, {color: r, events: n, zIndex: a=0} = e, p = {}, u = t.chart.renderer, g = e.to, f = e.from, m = e.value, x = e.borderWidth, y = e.label, {label: b, svgElem: v} = this, S = [], C, k = o(f) && o(g), M = o(m), w = !v, T = {
                            class: "highcharts-plot-" + (k ? "band " : "line ") + (e.className || "")
                        }, A = k ? "bands" : "lines";
                        if (!t.chart.styledMode && (M ? (T.stroke = r || "#999999",
                            T["stroke-width"] = c(e.width, 1),
                        e.dashStyle && (T.dashstyle = e.dashStyle)) : k && (T.fill = r || "#e6e9ff",
                        x && (T.stroke = e.borderColor,
                            T["stroke-width"] = x))),
                            p.zIndex = a,
                            A += "-" + a,
                        (C = t.plotLinesAndBandsGroups[A]) || (t.plotLinesAndBandsGroups[A] = C = u.g("plot-" + A).attr(p).add()),
                        v || (this.svgElem = v = u.path().attr(T).add(C)),
                            o(m))
                            S = t.getPlotLinePath({
                                value: s?.log2lin(m) ?? m,
                        ...
                        return !this.eventsAdded && n && (d(n, (t, e) => {
                            ...
                            y && (o(y.text) || o(y.formatter)) && S?.length && t.width > 0 && t.height > 0 && !S.isFlat ? (y = l({
                                ...
                                this.renderLabel(y, S, k, a)) : b && b.hide(),
                            this
                    }
                    renderLabel(t, e, i, n) {
                        let a = this.axis
            ...
            i(e, "Core/Tooltip.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Templating.js"], e["Core/Globals.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Utilities.js"]], function(t, e, i, s, r, o) {
                ...
                let {animObject: a} = t
                    ...
                    , {distribute: p} = s
                    , {addEvent: u, clamp: g, css: f, discardElement: m, extend: x, fireEvent: y, isArray: b, isNumber: v, isString: S, merge: C, pick: k, pushUnique: M, splat: w, syncTimeout: T} = o;
                class A {
                    constructor(t, e, i) {
                        this.allowShared = !0,
                            this.crosshairs = [],
                    ...
                    getLabel({anchorX: t, anchorY: e}={
                        ...
                        if (!this.label) {
                            if (this.outside) {
                                let t = this.chart.options.chart.style
                                    , e = r.getRendererType();
                                this.container = h = i.doc.createElement("div"),
                        ...
                        return h && !h.parentElement && i.doc.body.appendChild(h),
                            this.label
                    }
                    getPlayingField() {
                    ...
                    getPosition(t, e, i) {
                        ...
                        let T = !this.followPointer && k(i.ttBelow, !d && !a === w)
                            ...
                            , O = () => {
                                !1 !== A.apply(0, S) ? !1 !== P.apply(0, C) || M || (L(!0),
                                    O()) : M ? u.x = u.y = 0 : (L(!0),
                                    O())
                            }
                        ;
                    ...
                    refresh(t, e) {
                        ...
                        n && this.allowShared ? (r.applyInactiveState(a),
                            ...
                            (f = l.getLabelConfig()).points = d) : f = l.getLabelConfig(),
                            this.len = d.length;
                        let M = S(c) ? h(c, f, i) : p.call(f, this)
                            , T = l.series;
                        if (this.distance = k(T.tooltipOptions.distance, 16),
                        !1 === M)
                            this.hide();
                        else {
                            if (this.split && this.allowShared)
                                this.renderSplit(M, a);
                            else {
                                let t = v
                                    , o = C;
                                if (e && r.isDirectTouch && (t = e.chartX - i.plotLeft,
                                    o = e.chartY - i.plotTop),
                                i.polar || !1 === T.options.clip || a.some(e => r.isDirectTouch || e.series.shouldShowTooltip(t, o))) {
                                ...
                                let o = e[r - 1] || {
                                    ...
                                    if (!r) {
                                        ...
                                        f || (t.fill = y.backgroundColor,
                                            ...
                                            r = A.label("", 0, 0, y[o ? "headerShape" : "shape"], void 0, void 0, y.useHTML).addClass(i.getClassName(e, !0, o)).attr(t).add(T)
                                    }
                                    return r.isActive = !0,
                                        r.attr({
                                            text: s
            ...
            i(e, "Core/Series/Point.js", [e["Core/Renderer/HTML/AST.js"], e["Core/Animation/AnimationUtilities.js"], e["Core/Defaults.js"], e["Core/Templating.js"], e["Core/Utilities.js"]], function(t, e, i, s, r) {
                ...
                class k {
                    ...
                    setState(e, i) {
                        ...
                        M && M.size && w && "hidden" !== T && !this.isCluster ? (x || (s.halo = x = g.renderer.path().add(w.parentGroup)),
                ...
                class S {
                    ...
                    destroy() {
                        ...
                        this.eventsToUnbind.forEach(t => t()),
                            this.eventsToUnbind = [],
                        !e.chartCount && (S.unbindDocumentMouseUp && S.unbindDocumentMouseUp.forEach(t => t()),
                    ...
                    setDOMEvents() {
                        ...
                        S.unbindDocumentMouseUp || (S.unbindDocumentMouseUp = []),
                            S.unbindDocumentMouseUp.push(h(e, "mouseup", this.onDocumentMouseUp.bind(this)));
            ...
            i(e, "Core/Legend/LegendSymbol.js", [e["Core/Utilities.js"]], function(t) {
                ...
                return function(t) {
                    function e(t, e, o) {
                        let n = this.legendItem = this.legendItem || {}, {chart: a, options: h} = this, {baseline: l=0, symbolWidth: d, symbolHeight: c} = t, p = this.symbol || "circle", u = c / 2, g = a.renderer, f = n.group, m = l - Math.round((t.fontMetrics?.b || c) * (o ? .4 : .3)), x = {}, y, b = h.marker, v = 0;
            ...
            i(e, "Core/Series/Series.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Defaults.js"], e["Core/Foundation.js"], e["Core/Globals.js"], e["Core/Legend/LegendSymbol.js"], e["Core/Series/Point.js"], e["Core/Series/SeriesDefaults.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Renderer/SVG/SVGElement.js"], e["Core/Utilities.js"]], function(t, e, i, s, r, o, n, a, h, l) {
                let {animObject: d, setAnimation: c} = t
                    ...
                    , {svg: g, win: f} = s
                    , {seriesTypes: m} = a
                    , {arrayMax: x, arrayMin: y, clamp: b, correctFloat: v, crisp: S, defined: C, destroyObjectProperties: k, diffObjects: M, erase: w, error: T, extend: A, find: P, fireEvent: L, getClosestDistance: O, getNestedProperty: D, insertItem: E, isArray: I, isNumber: j, isString: B, merge: R, objectEach: z, pick: N, removeEvent: W, splat: G, syncTimeout: H} = l;
                class X {
                    constructor() {
                        this.zoneAxis = "y"
                    }
                    ...
                    update(t, e) {
                        ...
                        t.data && (t.dataSorting && A(i.options.dataSorting, t.dataSorting),
            ...
            i(e, "Core/Legend/Legend.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Foundation.js"], e["Core/Globals.js"], e["Core/Series/Series.js"], e["Core/Series/Point.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Templating.js"], e["Core/Utilities.js"]], function(t, e, i, s, r, o, n, a) {
                ...
                let {animObject: l, setAnimation: d} = t
                    ...
                    , {distribute: g} = o
                    , {format: f} = n
                    , {addEvent: m, createElement: x, css: y, defined: b, discardElement: v, find: S, fireEvent: C, isNumber: k, merge: M, pick: w, pushUnique: T, relativeLength: A, stableSort: P, syncTimeout: L} = a;
                class O {
                    constructor(t, e) {
                        this.allItems = [],
                            this.initialItemY = 0,
                    ...
                    render() {
                        ...
                        this.itemX = s,
                            ...
                            this.offsetWidth = 0,
                            this.lastItemY = 0,
                            this.widthOption = A(i.width, t.spacingBox.width - s),
            ...
            i(e, "Core/Chart/Chart.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Axis/Axis.js"], e["Core/Defaults.js"], e["Core/Templating.js"], e["Core/Foundation.js"], e["Core/Globals.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Series/Series.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Renderer/SVG/SVGRenderer.js"], e["Core/Time.js"], e["Core/Utilities.js"], e["Core/Renderer/HTML/AST.js"], e["Core/Axis/Tick.js"]], function(t, e, i, s, r, o, n, a, h, l, d, c, p, u) {
                let {animate: g, animObject: f, setAnimation: m} = t
                    ...
                    , {seriesTypes: T} = h
                    , {addEvent: A, attr: P, createElement: L, css: O, defined: D, diffObjects: E, discardElement: I, erase: j, error: B, extend: R, find: z, fireEvent: N, getStyle: W, isArray: G, isNumber: H, isObject: X, isString: F, merge: Y, objectEach: U, pick: V, pInt: $, relativeLength: Z, removeEvent: _, splat: q, syncTimeout: K, uniqueKey: J} = c;
                class Q {
                    static chart(t, e, i) {
                        return new Q(t,e,i)
                    }
                    ...
                    getChartSize() {
                        ...
                        this.chartWidth = Math.max(0, e || s.width || 600),
                            this.chartHeight = Math.max(0, Z(i, this.chartWidth) || (r ? s.height : 400)),
                            this.containerBox = s
                    }
                    temporaryDisplay(t) {
                    ...
                    getContainer() {
                        let t = this.options, e = t.chart, i = "data-highcharts-chart", s = J(), r, o = this.renderTo;
                        o || (this.renderTo = o = e.renderTo),
                        F(o) && (this.renderTo = o = C.getElementById(o)),
                        o || B(13, !0, this);
                        let a = $(P(o, i));
                        H(a) && S[a] && S[a].hasRendered && S[a].destroy(),
                            P(o, i, this.index),
                        ...
                        this.container = c,
                            this.getChartSize(),
                        d === this.chartWidth || (d = this.chartWidth,
                        this.styledMode || O(c, {
                        ...
                        if (this.renderer = new u(c,d,h,void 0,e.forExport,t.exporting && t.exporting.allowHTML,this.styledMode),
                            m(void 0, this),
                    ...
                    propFromSeries() {
                        ...
                        ["inverted", "angular", "polar"].forEach(function(n) {
                            for (e = T[r.type],
                                     ...
                                     t = o && o.length; !i && t--; )
                                (e = T[o[t].type]) && e.prototype[n] && (i = !0);
                            s[n] = i
                        })
                    }
                    linkSeries(t) {
                        ...
                        for (let t of (this.hoverPoints?.forEach(t => t.setState()),
                            ...
                            1 === v && !r && "yAxis" === t.coll && !T) {
                                for (let e of t.series) {
                                    ...
                                    H(t.dataMin) && H(t.dataMax) && (T.dataMin = Math.min(t.dataMin, T.dataMin),
                                        T.dataMax = Math.max(t.dataMax, T.dataMax))
                                }
                                t.allExtremes = T
                            }
                            let {dataMin: A, dataMax: P, min: L, max: O} = R(t.getExtremes(), T || {})
                                , E = A ?? g.min
                                , I = P ?? g.max
                                , j = w - M
                            ...
                            (!t.isOrdinal || t.options.overscroll || 1 !== v || r) && (M < G && (M = G,
                            v >= 1 && (w = M + j)),
                            w > X && (w = X,
                            v >= 1 && (M = w - j)),
                ...
                class g {
                    ...
                    applyFixed() {
                        ...
                        let S = u - o[0] - 1
                            ...
                            , T = u + c - m
                            , A = [["M", 0, 0]];
                        f ? A = [["M", 0, S], ["L", p - 1, S], ["L", p - 1, k], ["L", 0, k], ["Z"], ["M", w, S], ["L", n, S], ["L", n, k], ["L", w, k], ["Z"]] : m && (A = [["M", C, 0], ["L", C, u - 1], ["L", M, u - 1], ["L", M, 0], ["Z"], ["M", C, T], ["L", C, a], ["L", M, a], ["L", M, T], ["Z"]]),
            ...
            i(e, "Core/Axis/Stacking/StackingAxis.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Axis/Axis.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Axis/Stacking/StackItem.js"], e["Core/Utilities.js"]], function(t, e, i, s, r) {
                ...
                function M(t, e) {
                    ...
                    for (P.stacksTouched += 1,
                        ...
                        let e = o.total || 0;
                        "percent" === f ? (n = r ? w : T,
                            e = A && L[n]?.[p] ? (n = L[n][p]).total = Math.max(n.total || 0, e) + Math.abs(g) || 0 : l(e + (Math.abs(g) || 0))) : "group" === f ? (u(g) && (g = g[0]),
                        null !== g && e++) : e = l(e + (g || 0)),
                    ...
                    translate() {
                        ...
                        i.pointPadding && (S = Math.ceil(S)),
                            ...
                            t.points.forEach(function(s) {
                                let r = y(s.yBottom, v), o = 999 + Math.abs(r), g = s.plotX || 0, C = d(s.plotY, -o, a.len + o), k, M = Math.min(C, r), w = Math.max(C, r) - M, T = u, A = g + f, P = S;
                                l && Math.abs(w) < l && (w = l,
                                ...
                                p(s.options.pointWidth) && (A -= Math.round(((T = P = Math.ceil(s.options.pointWidth)) - u) / 2)),
                                i.centerInCategory && !i.stacking && (A = t.adjustForMissingColumns(A, T, s, c)),
                                    s.barX = A,
                                    s.pointWidth = T,
                                    s.tooltipPos = e.inverted ? [d(a.len + a.pos - e.plotLeft - C, a.pos - e.plotLeft, a.len + a.pos - e.plotLeft), n.len + n.pos - e.plotTop - A - P / 2, w] : [n.left - e.plotLeft + A + P / 2, d(C + a.pos - e.plotTop, a.pos - e.plotTop, a.len + a.pos - e.plotTop), w],
                                    s.shapeType = t.pointClass.prototype.shapeType || "roundedRect",
                                    s.shapeArgs = t.crispCol(A, s.isNull ? v : M, P, s.isNull ? 0 : w)
                            }),
                            ...
                            t.forEach(t => {
                                    ...
                                    f(b(y, t.dlOptions || t.options?.dataLabels)).forEach( (c, f) => {
                                            let m = c.enabled && (t.visible || t.dataLabelOnHidden) && (!t.isNull || t.dataLabelOnNull) && function(t, e) {
                                                ...
                                                return !0
                                            }(t, c), {backgroundColor: y, borderColor: b, distance: v, style: S={}} = c, C, k, M, w, T = {}, A = r[f], P = !A, L;
                                            ...
                                            s.styledMode || (T.fill = "auto" === y ? t.color : y,
                                                T.stroke = "auto" === b ? t.color : b,
                                                T["stroke-width"] = c.borderWidth),
                                                p(T, (t, e) => {
                                                        void 0 === t && delete T[e]
                                                    }
                                                )),
                                            !A || m && n(M) && !!A.div == !!c.useHTML && (A.rotation && c.rotation || A.rotation === c.rotation) || (A = void 0,
                                                P = !0),
                                            m && n(M) && (A ? T.text = M : (A = l.label(M, 0, 0, c.shape, void 0, void 0, c.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t.colorIndex + " " + (c.className || "") + (c.useHTML ? " highcharts-tracker" : "")),
                                            A && (A.options = c,
                                                A.attr(T),
                                                s.styledMode ? S.width && A.css({
                                                    width: S.width,
                                                    textOverflow: S.textOverflow
                                                }) : A.css(S).shadow(c.shadow),
                                                h(A, "beforeAddingDataLabel", {
                                                    labelOptions: c,
                                                    point: t
                                                }),
                                            A.added || A.add(e),
                                                i.alignDataLabel(t, A, c, void 0, P),
                                                A.isActive = !0,
                                            r[f] && r[f] !== A && r[f].destroy(),
                                                r[f] = A))
                                        }
                                    );
                                    let c = r.length;
                                        ...
                                        e.forEach(i => {
                                                (i.dataLabels || []).forEach(h => {
                                                        let l = h.options || {}
                                                            ...
                                                            , T = "inherit";
                                                        if (f) {
                                                            if (d && p(g) && f.distance > 0 && (void 0 === g.pos ? T = "hidden" : (S = g.size,
