...
$this->title = 'Вы вошли как Администратор';
                    ...
                    <div class="project-list">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th scope="col">№</th>
                                    <th scope="col" class="table-header">Заголовок</th> <!-- Изменено название -->
                                ...
                                <?php foreach ($posts as $post): ?>
                                    <tr>
                                        <td data-label="№">
                                            <span class="label label-primary" ><?= $post->publication_id ?></span>
                                        </td>
                                        <td >
                                        ...
                                        <td class="date-cell" >
                                            <span class="label label-primary" ><?= $post->data ?></span>
                                        </td>
                                        <td class="link-cell" >
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <a href="<?= $post->source ?>" class="label label-primary"
